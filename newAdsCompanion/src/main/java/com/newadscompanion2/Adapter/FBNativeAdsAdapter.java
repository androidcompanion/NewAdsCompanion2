package com.newadscompanion2.Adapter;
...
public class FBNativeAdsAdapter extends RecyclerViewAdapterWrapper {
    ...
    private FBNativeAdsAdapter(Param param) {
        super(param.adapter);
        this.mParam = param;
    ...
    private RecyclerView.ViewHolder onCreateAdViewHolder(ViewGroup parent) {
        ...
        LinearLayout adLayoutContent = (LinearLayout) inflater
                .inflate(R.layout.facebook_native_ad_small, parent, false);
    ...
    public static class Builder {
        ...
        public FBNativeAdsAdapter build() {
            return new FBNativeAdsAdapter(mParam);
        }
